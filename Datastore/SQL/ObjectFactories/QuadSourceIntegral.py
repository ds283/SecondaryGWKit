...
class sqla_QuadSourceIntegral_factory(SQLAFactoryBase):
    ...
    def register():
        return {
            ...
            "columns": [
                ...
                sqla.Column("WKB_Levin_max_depth", sqla.Integer, nullable=True),
    ...
    def build(payload, conn, table, inserter, tables, inserters):
        ...
        query = sqla.select(
            ...
            table.c.WKB_Levin_chebyshev_min_order,
            table.c.WKB_Levin_max_depth,
        ...
        obj = QuadSourceIntegral(
            payload={
                ...
                "WKB_Levin_data": LevinData(
                    ...
                    chebyshev_min_order=row_data.WKB_Levin_chebyshev_min_order,
                    max_depth=row_data.WKB_Levin_max_depth,
        ...
        try:
            store_id = inserter(
                conn,
                {
                    ...
                    "WKB_Levin_chebyshev_min_order": (
                        WKB_Levin_data.chebyshev_min_order
                        if WKB_Levin_data is not None
                        else None
                    ),
                    "WKB_Levin_max_depth": (
                        WKB_Levin_data.max_depth if WKB_Levin_data is not None else None
                    ),
                    "WKB_Levin_elapsed": (
            ...
            obj = QuadSourceIntegral(
                payload={
                    ...
                    "WKB_Levin_data": LevinData(
                        ...
                        chebyshev_min_order=row.WKB_Levin_chebyshev_min_order,
                        max_depth=row.WKB_Levin_max_depth,
