...
prompts plus four follow-ups — 14, 15, 16, 17 — of which 15 are executed;
prompt 17 and prompt 13 remain). `[07-phase-spline-chunking-precision]` was closed WONTFIX on
