...
def autoscale(ax=None, axis="y", margin=0.1):
    ...
    Extracted from https://gist.github.com/thomasaarholt/c8440b132aaea9f71f0588af486ad457
    Described at https://stackoverflow.com/questions/29461608/fixing-x-axis-scale-and-autoscale-y-axis
    """
    if ax is None:
        ax = plt.gca()
