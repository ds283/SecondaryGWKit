...
**Last updated:** 2026-09-18 · **Status: in progress — 6 / 6 measured, plus the insertions 02a, 04b, 05b, 05a and **06**; **04b has landed the block prompt 04 stopped short of writing**, **05 has landed the schema change**, **05b has made the recorded order the order that was used**, **05a has decoupled the tolerances that are real** and **06 has measured `QuadSourceIntegral` read-only and regenerated the inventory**; every measurement the campaign set out to take is now taken, and only the close-out is left. **§7 D11 split §3.6 on 2026-09-18**: **06** took the `QuadSourceIntegral` measurement and the inventory regeneration, **T11**, and has landed; **06a** takes the close-out document and `docs/TOLERANCE-PROVENANCE.md`, **T12**, and is written against what 06 leaves.**
...
| 06a | Close-out and the provenance note | README §1.2, §3.6a, §6.2; §7 **D11** | Opus | ⏸️ **held** | ⬜ | | |
