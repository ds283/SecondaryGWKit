...
def tianqin_psd_components(f: np.ndarray, acc_noise_level: float = 1e-15, oms_noise_level: float = 1e-12) -> tuple[np.ndarray, np.ndarray]:
...
def taiji_psd_components(f: np.ndarray, acc_noise_level: float = 3e-15, oms_noise_level: float = 8e-12) -> tuple[np.ndarray, np.ndarray]:
...
def averaged_tianqin_fplus_sq_numerical(f: np.ndarray, len_arm: float = np.sqrt(3)*1e8) -> np.ndarray:
...
def sensitivity_curve_tianqin_analytical(flow: float, fhigh: float, Npts: int,
                                         len_arm: float = np.sqrt(3)*1e8,
                                         acc_noise_level: float = 1e-15,
                                         oms_noise_level: float = 1e-12) -> tuple[np.ndarray, np.ndarray]:
...
def sensitivity_curve_taiji_analytical(flow: float, fhigh: float, Npts: int,
                                       len_arm: float = 3e9, acc_noise_level: float = 3e-15,
                                       oms_noise_level: float = 8e-12) -> tuple[np.ndarray, np.ndarray]:
    fr = np.logspace(np.log10(flow), np.log10(fhigh), Npts)
...
# Load data files
data_lisa = np.loadtxt("plis_LISA.dat", comments='#')
data_decigo = np.loadtxt("plis_DECIGO.dat", comments='#')
data_et = np.loadtxt("plis_ET.dat", comments='#')
data_ipta = np.loadtxt("plis_IPTA.dat", comments='#')
data_epta = np.loadtxt("plis_EPTA.dat", comments='#')
data_nanograv = np.loadtxt("plis_NANOGrav.dat", comments='#')
data_SKA = np.loadtxt("plis_SKA.dat", comments='#')
...
plt.text(5.33e-5, 1.106e-11 , r"\textbf{LISA}", style='normal', fontsize=18, color='CadetBlue',
         verticalalignment='center', horizontalalignment='center', rotation = 'horizontal',
          bbox={'facecolor': 'white', 'alpha': 0.12, 'pad': 5},zorder=3)
...
#          verticalalignment='center', horizontalalignment='center', rotation = 'horizontal',
#           bbox={'facecolor': 'white', 'alpha': 0.12, 'pad': 5},zorder=3)
plt.text(0.00099, 5.72e-10 , r"\textbf{Taiji}", style='normal', fontsize=18, color='purple',
         verticalalignment='center', horizontalalignment='center', rotation = 'horizontal',
          bbox={'facecolor': 'white', 'alpha': 0.12, 'pad': 5},zorder=3)
plt.text(0.1, 5.4e-8 , r"\textbf{TianQin}", style='normal', fontsize=18, color='orange',
         verticalalignment='center', horizontalalignment='center', rotation = 'horizontal',
          bbox={'facecolor': 'white', 'alpha': 0.12, 'pad': 5},zorder=3)
